        ...
        for line in f.readlines():
            if last_line != "":
                ...
                if chrom == last_chrom:
                    ...
                    out_list.append([chrom, int(pos), distance, fisher_ratio, -math.log10(fisher_p) + 0])  # get the log10 p value and add 0 to get rid of the -0.0
            last_line = line
